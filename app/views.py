...
from .models import Employee,Department, Function, EmployeeHistory, Benefit, MenuItem, MenuCategory, News, NewsCategory , Contact , ContactGroup, Country
...
class UserProduct(BaseView):
    ...
    def userproduct(self):
        return self.render_template('product/userproduct.html')
        
appbuilder.add_view(UserProduct,"MyProduct",icon="fas fa-cubes")
